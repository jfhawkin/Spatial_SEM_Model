...
for i in range(1, NSIMS + 1, 1):
    ...
    db.columns = ["uno", "sero", "householdid", "householdzone", "daycaredist", "facdist", "homedist", "shopdist",
                  "othdist",
...
if NSIMS == 100:
    ...
    ax.set_xticks(ind)
    ax.set_xticklabels(
        ("CONSTANT", "HHVEH", "HHSIZE", "HHINC", "SEX", "AVG PRICE", "AUTOTRIPS", "ACTIVETRIPS", "RHO", "LAMBDA"))
    ax.legend()
