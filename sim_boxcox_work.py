...
# z_names = ["lic", "hhsize", "sex", "activetrip", "t_long"]
# z_names = ["lic", "hhsize", "sex", "activetrip", "t_long", "t_local", "veh_adult", "empstat_5", "taz_region_2", "taz_region_3", "taz_region_4", "taz_region_5", "age_26_64", "age_65"]
# z_names = ["lic", "hhsize", "sex", "activetrip", "t_long", "t_local", "veh_adult", "empstat_5", "taz_region_2", "taz_region_3", "taz_region_4", "taz_region_5", "taz_area_ind"]
z_names = ["sex", "activetrip", "t_long", "t_local", "veh_adult", "empstat_5", "taz_region_2", "taz_region_345", "taz_area_ind"]
...
for i in range(1, NSIMS+1, 1):
    ...
    df['taz_region_345'] = (df['taz_region_3']==1 | (df['taz_region_4']==1)| (df['taz_region_5']==1)).astype(int)
...
if NSIMS > 1:
    ...
    ax.set_xticks(ind)
    ax.set_xticklabels(("CONSTANT", "POP DENS", "GENDER", "ACTIVE TRIPS", "TRANSIT LONG", "TRANSIT LOCAL", "VEH RATE", "NO WORK", "REGION 2", "REGION 345", "TAZ INDUS", "RHO", "LAMBDA"))
    ax.legend()
    plt.xticks(rotation=45)

    plt.savefig('boxcox_work.png')