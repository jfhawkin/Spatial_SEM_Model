...
def ML_Lag_BC(reg, w, vm, spat_diag, regimes=False, LM=False):  # extra space d
    reg.__summary = {}
    # compute diagnostics and organize summary output
    beta_diag_lag(reg, robust=None, error=False)
    reg.__summary['summary_r2'] += "%-20s:%12.3f                %-22s:%12.3f\n" % (
    ...
    if LM:
        reg.__summary['summary_r2'] += "                                                 %-22s:%12.3f (%1.3f)\n" % (
            'LM joint rho 0 and lambda 0', reg.LM_J_R0_L0, chi2.sf(reg.LM_J_R0_L0, df1))
        reg.__summary['summary_r2'] += "                                                 %-22s:%12.3f (%1.3f)\n" % (
            'LM joint rho 0 and lambda 1', reg.LM_J_R0_L1, chi2.sf(reg.LM_J_R0_L1, df2))
        reg.__summary['summary_r2'] += "                                                 %-22s:%12.3f (%1.3f)\n" % (
            'LM 1D rho 0|lambda 0', reg.LM_1_R0_L0, chi2.sf(reg.LM_1_R0_L0, df3))
        reg.__summary['summary_r2'] += "                                                 %-22s:%12.3f (%1.3f)\n" % (
            'LM 1D rho 0|lambda 1', reg.LM_1_R0_L1, chi2.sf(reg.LM_1_R0_L1, df4))
        reg.__summary['summary_r2'] += "                                                 %-22s:%12.3f (%1.3f)\n" % (
            'LM 1D lambda 0|rho 0', reg.LM_1_L0_R0, chi2.sf(reg.LM_1_L0_R0, df5))
        reg.__summary['summary_r2'] += "                                                 %-22s:%12.3f (%1.3f)\n" % (
            'LM 1D lambda 1|rho 0', reg.LM_1_L1_R0, chi2.sf(reg.LM_C_RU_L1, df6))
        reg.__summary['summary_r2'] += "                                                 %-22s:%12.3f (%1.3f)\n" % (
            'LM cond. rho 0 and lambda unknown', reg.LM_C_R0_LU, chi2.sf(reg.LM_C_R0_LU, df7))
        reg.__summary['summary_r2'] += "                                                 %-22s:%12.3f (%1.3f)\n" % (
            'LM cond. rho unknown and lambda 0', reg.LM_C_RU_L0, chi2.sf(reg.LM_C_RU_L0, df8))
        reg.__summary['summary_r2'] += "                                                 %-22s:%12.3f (%1.3f)\n" % (
            'LM cond. rho unknown and lambda 1', reg.LM_C_RU_L1, chi2.sf(reg.LM_C_RU_L1, df9))
    # build coefficients table body
    summary_coefs_allx(reg, reg.z_stat)
    if regimes:
        summary_regimes(reg)
